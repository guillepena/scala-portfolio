...
package object iotexample {
  ...
  object IotDomain {
    ...
    case object Temperature extends SensorType {
      ...
      override val typeName: String = "temperature-device"
    }

    case object Humidity extends SensorType {
      override val min: Double = 0
      override val max: Double = 100
      override val typeName: String = "humidity-device"
    }
    ...
    case object Pressure extends SensorType {
      ...
      override val typeName: String = "pressure-device"
    }
  ...
  object IotDataValidations {
    ...
    // 4. El tipo de sensor debe ser uno de los siguientes: "temperature-device", "humidity-device", "pressure-device".
    ...
    // Si el sensor es de tipo "temperature-device", debe contener la temperatura y esta ser valida.
    // Si el sensor es de tipo "humidity-device", debe contener la humedad y esta ser valida.
    // Si el sensor es de tipo "pressure-device", debe contener la presión y esta ser valida.
